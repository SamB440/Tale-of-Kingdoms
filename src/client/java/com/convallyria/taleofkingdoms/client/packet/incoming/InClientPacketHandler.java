...
public abstract class InClientPacketHandler<T extends CustomPayload> extends PacketHandler<T> {

    public InClientPacketHandler(CustomPayload.Id<T> packet, PacketCodec<RegistryByteBuf, T> codec) {
        super(packet, codec);
    }
