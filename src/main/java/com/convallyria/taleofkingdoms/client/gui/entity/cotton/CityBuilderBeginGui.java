...
public class CityBuilderBeginGui extends LightweightGuiDescription {
    ...
    public CityBuilderBeginGui() {
        ...
        root.add(new WLabel(Text.literal("City Builder"), 11111111).setVerticalAlignment(VerticalAlignment.CENTER).setHorizontalAlignment(HorizontalAlignment.CENTER), 200, 10, 8, 2);
