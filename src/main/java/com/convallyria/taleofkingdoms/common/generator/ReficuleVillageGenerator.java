...
public class ReficuleVillageGenerator {
    ...
    private static final Identifier TOP_TEMPLATE = new Identifier(TaleOfKingdoms.MODID, "reficule_village/reficule_village_one");

    public static void addPieces(StructureManager manager, BlockPos pos, BlockRotation rotation, List<StructurePiece> pieces) {
        pieces.add(new ReficuleVillagePiece(manager, pos, TOP_TEMPLATE, rotation));
    }
