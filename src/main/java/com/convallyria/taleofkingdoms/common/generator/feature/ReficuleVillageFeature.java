...
public class ReficuleVillageFeature extends StructureFeature<NoneFeatureConfiguration> {

    public ReficuleVillageFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public static class Start extends StructureStart<NoneFeatureConfiguration> {
        ...
        public void generatePieces(RegistryAccess dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            ReficuleVillageGenerator.addPieces(structureManager, pos, rotation, this.pieces);
            this.getBoundingBox();
        }
    }
}