...
public enum Schematic {
    GUILD_CASTLE("guild/guildnew"),
    TIER_1_KINGDOM("player_kingdom/tier_one"),
    TIER_2_KINGDOM("player_kingdom/tier_two"),
    TIER_1_BLACKSMITH_HOUSE("player_kingdom/blacksmith/tier_one_house_blacksmith"),
    ...
    //GUILD_CASTLE_OLD(Identifier.of(TaleOfKingdoms.MODID, "/assets/schematics/GuildCastle.schematic"));

    private final Identifier path;

    Schematic(String path) {
        this(Identifier.of(TaleOfKingdoms.MODID, path));
    }
